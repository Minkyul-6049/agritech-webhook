...
func main() {
        // 1. Load environment variables for secure Telegram credentials
        ...
        // Main alert receiver endpoint (Triggered by Grafana Alerting Webhook)
...
func healthCheckHandler(w http.ResponseWriter, r *http.Request) {
        ...
        w.Write([]byte("OK: Agritech Webhook Server is running securely.\n"))
}
...
func sendTelegramMessage(botToken string, chatID string, text string) {
        ...
        // Execute the HTTP POST request to Telegram endpoint
